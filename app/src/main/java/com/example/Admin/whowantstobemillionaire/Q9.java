...
public class Q9 extends AppCompatActivity {
    ...
    private void setData()
    {
        ...
        question.setText(qq+"The candy bar Twix PB adds what flavor to Twix?");
        Answer1.setText("Pancake Batter");
        Answer2.setText("Peach Brandy");
        Answer3.setText("Pickle Brine");
        Answer4.setText("Peanut Butter");
    }
    private void next()
    {
        int selected=0;
